...
<body>
  ...
  <div class="write-container">
    ...
    <form action="/board/bwrite" class="write-form" id="writeForm" name="writeFrm" method="post" enctype="multipart/form-data">
      <input type="text" name="id" id="writer" placeholder="작성자" maxlength="20" />
      <input type="text" name="btitle" id="title" placeholder="제목" maxlength="100" />
      <textarea name="bcontent" id="content" placeholder="내용을 입력하세요." maxlength="2000"></textarea>

      <input type="file" id="bfile" name="file" onchange="readURL(this);" />
      <div>
  ...
  <script>
    ...
    writeForm.addEventListener('submit', (e) => {
      ...
      // 예시: 목록 페이지로 이동
      //window.location.href = '/board/bwirte';
      writeFrm.submit();
