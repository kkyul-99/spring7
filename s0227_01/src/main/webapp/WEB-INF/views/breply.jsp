...
<body>
  ...
  <div class="write-container">
    <div class="write-title">게시글 답변달기</div>
    <form action="/board/breply" method="post" name="bFrm"
    class="write-form" id="writeForm" enctype="multipart/form-data">
      ...
      <input type="text" id="title" value="[답변] ${board.btitle}" name="btitle" placeholder="제목" maxlength="100" required />
      <textarea id="content" name="bcontent" placeholder="내용을 입력하세요." maxlength="2000" required>
[답변]
------------------------------
