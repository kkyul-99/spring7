...
<body>
  ...
  <div class="detail-container">
	...
	<div class="prev-next">
	  <div class="prev-post">
	    <span>이전글</span>
	    <c:if test="${preDto == null}">해당 게시글이 없습니다.</c:if>
	    <c:if test="${preDto != null}">
          <a href="/board/bview/${preDto.bno}">${preDto.btitle}</a>
	    </c:if>
	  </div>
	  <div class="next-post">
	    <span>다음글</span>
	    <c:if test="${nextDto == null}">해당 게시글이 없습니다.</c:if>
	    <c:if test="${nextDto != null}">
	      <a href="/board/bview/${nextDto.bno}">${nextDto.btitle}</a>
	    </c:if>
	  </div>
	</div>
